...
#
# RCS: @(#) $Id: bind.tcl,v 1.1 2004/08/20 00:04:48 bruce_johnson Exp $
...
if {[winfo depth $w] > 1} {
    ...
    set normal "-background white -relief flat"
} else {
    set bold "-foreground white -background black"
    set normal "-foreground red -background white"
}
...
$w.text insert end {1. Samples of all the different types of items that can be created in canvas widgets.} d1
$w.text insert end \n\n
$w.text insert end {2. A simple two-dimensional plot that allows you to adjust the positions of the data points.} d2
$w.text insert end \n\n
$w.text insert end {3. Anchoring and justification modes for text items.} d3
$w.text insert end \n\n
$w.text insert end {4. An editor for arrow-head shapes for line items.} d4
$w.text insert end \n\n
$w.text insert end {5. A ruler with facilities for editing tab stops.} d5
$w.text insert end \n\n
$w.text insert end {6. A grid that demonstrates how canvases can be scrolled.} d6
