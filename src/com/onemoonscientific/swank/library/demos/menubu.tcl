...
#
# # RCS: @(#) $Id: menubu.tcl,v 1.1 2004/08/20 00:04:51 bruce_johnson Exp $
...
menubutton $w.body.below -text "Below" -underline 0 -menu $w.body.below.m -relief raised
...
menubutton $w.body.right -text "Right" -underline 0  -menu $w.body.right.m -relief raised
...
menubutton $w.body.left -text "Left" -underline 0  -menu $w.body.left.m -relief raised
...
menubutton $w.body.above -text "Above" -underline 0  -menu $w.body.above.m -relief raised
