...
# well-known sayings.
#
# RCS: @(#) $Id: sayings.tcl,v 1.1 2004/08/20 00:04:52 bruce_johnson Exp $
...
listbox $w.frame.list -width 20 -height 6 -setgrid 1 -yscrollcommand "$w.frame.yscroll set" -xscrollcommand "$w.frame.xscroll set"
jscrollpane $w.frame.spane
$w.frame.spane add $w.frame.list
pack $w.frame.spane -fill both -expand yes
#grid $w.frame.spane -row 0 -column 0 -rowspan 1 -columnspan 1 -sticky news
