...
#
# RCS: @(#) $Id: style.tcl,v 1.1 2004/08/20 00:04:53 bruce_johnson Exp $
...
jscrollpane $w.scroll
$w.scroll add $w.text
pack $w.scroll -expand yes -fill both
...
$w.text tag configure super -superscript 1
$w.text tag configure sub -subscript 1
$w.text tag configure margins -lmargin1 12m -lmargin2 6m -rmargin 10m
$w.text tag configure spacing  -spacing1 10p -spacing2 0.0p\
