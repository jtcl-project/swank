...
#
# RCS: @(#) $Id: text.tcl,v 1.1 2004/08/20 00:04:53 bruce_johnson Exp $
...
$w.scroll add $w.text
pack $w.scroll -side right -fill both -expand yes
#pack $w.text -expand yes -fill both
set text {This window is a text widget.  It displays one or more lines of text
