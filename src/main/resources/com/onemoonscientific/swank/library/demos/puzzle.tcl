...
# of buttons.
#
# RCS: @(#) $Id: puzzle.tcl,v 1.1 2004/08/20 00:04:52 bruce_johnson Exp $
...
for {set i 0} {$i < 15} {set i [expr $i+1]} {
    ...
    button $w.frame.$num -relief raised -text $num -highlightthickness 0 -command "puzzleSwitch $w $num"
    place $w.frame.$num -relx $xpos($num) -rely $ypos($num) -relwidth .25 -relheight .25
}
set xpos(space) .75
set ypos(space) .75
