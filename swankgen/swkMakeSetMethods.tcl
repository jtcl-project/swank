...
global specialGets widgetVar components tkcomps resourceNames specialConfig optionList widgetType
       ...
       array set simpleTypes {java.lang.String s int i orient i textvariable s wrap s variable s justify s state s tkSize i tkSizeD d tkRelief s tkSelectMode i boolean b float f double d }
...
set configOPTs ""
set configCASEs  "
        int opt = TclIndex.get(interp, argv\[i\], validCmds, \"option\", 0);
        switch (opt) \{
"
set setterCASEs  "
        switch (opt) \{
