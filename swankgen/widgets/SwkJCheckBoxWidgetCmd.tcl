...
append specialWidgetTypeCmds {
	if ((swkjcheckbox.commandListener.varName == null) || (swkjcheckbox.commandListener.varName == "")) {
		swkjcheckbox.commandListener.setVarName(interp,argv[1].toString().substring(argv[1].toString().lastIndexOf(".")+1));
	}
}
